...
message.delete(3000);
    if(message.author.id !== "521341978659651596") return message.reply(' ').then(msg => msg.delete(3000));
...
p11.on('ready', () => {
p11.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p12.on('ready', () => {
p12.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p13.on('ready', () => {
p13.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p14.on('ready', () => {
p14.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p15.on('ready', () => {
p15.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p16.on('ready', () => {
p16.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p17.on('ready', () => {
p17.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p18.on('ready', () => {
p18.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p19.on('ready', () => {
p19.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p20.on('ready', () => {
p20.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p21.on('ready', () => {
p21.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p22.on('ready', () => {
p22.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p23.on('ready', () => {
p23.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p24.on('ready', () => {
p24.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p25.on('ready', () => {
p25.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p26.on('ready', () => {
p26.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p27.on('ready', () => {
p27.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p28.on('ready', () => {
p28.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p29.on('ready', () => {
p29.user.setActivity("M.#0080",{type: 'LISTENING'})
});
p30.on('ready', () => {
p30.user.setActivity("M.#0080",{type: 'LISTENING'})
});
//////////////////////////////////////////////////////////////////////////////////////////////////
p1.on("message", message => {
          if (message.author.bot) return;
...
message.delete(3000);
    if(message.author.id !== "521341978659651596") return message.reply(' ').then(msg => msg.delete(3000));
message.channel.send('#rep <@!521341978659651596>').then(s => {
s.delete(3000);
});
message.channel.send('->rep <@!521341978659651596>').then(s => {
s.delete(3000);
...
p8.on("message", message => {
      ...
      if(!message.channel.guild) return;
        if(message.content.startsWith(prefix + "rep")) {
message.delete(3000);
    if(message.author.id !== "521341978659651596") return message.reply('كل زق ').then(msg => msg.delete(3000));
message.channel.send('#rep <@!521341978659651596>').then(s => {
s.delete(3000);
});
message.channel.send('->rep <@!521341978659651596>').then(s => {
...
message.channel.send('->daily <@!521341978659651596>').then(s => {
s.delete(3000);
});
}
});
